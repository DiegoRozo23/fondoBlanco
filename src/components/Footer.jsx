...
const Footer = (props) =>{
    return(
        <div>
            <footer className="p-9 bg-gray-300 sm:p-6 dark:bg-gray-900 mt-9">
  <div className="md:flex md:justify-between">

      <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ml-20">
          <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Fondo Blanco</h2>
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols3">
        <h5 className="text-xl">
          FONDO BLANCO
        </h5>
        <div className="md:mb-1 mr-20">

          <p className="text-gray-800">
            <strong>¿Quieres estar pendiente de las ultimas ofertas? dejanos tu correo</strong>
          </p>
        </div>
        <div className="">
          <form action="">
  ...
  <div className="sm:flex sm:items-center sm:justify-center">
      <span className=" text-gray-500 sm:text-center dark:text-gray-400">Copyright @2022         
      </span>
      <div className="flex mt-10 ml-20 space-x-6 sm:justify-center sm:mt-0">
